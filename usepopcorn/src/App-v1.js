...
function MovieList({ movies, selectedId, handleSelectedMovie }) {
  return (
...
function MovieDetails({
  ...
  function handleAdd(selectedId) {
    ...
    !alreadyWatched && onAddWatchedMovie(newWatchedMovie);
    onCloseMovie();
  }
              ...
              {!alreadyWatched ? (
                <>
                  <StarRating
                    maxRating={10}
                    size={26}
                    onSetRating={userRating > 0 ? userRating : setUserRating}
                  />
                  {userRating > 0 && (
                    <button
                      className="btn-add"
